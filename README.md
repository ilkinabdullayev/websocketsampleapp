...
To build the final jar and optimize the websocketsampleapp application for production, run:
...
Then navigate to [http://localhost:7272](http://localhost:7272) in your browser.
